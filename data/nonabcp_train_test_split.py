...
def write_split_fasta(input_fasta, folds, test_fold=0):
    ...
    SeqIO.write(train_records, "non_abcp_train.fasta", "fasta")
    SeqIO.write(test_records, "non_abcp_test.fasta", "fasta")
...
# Main
# -----------------------------
clstr_file = "Non_ABCP_clustered.fasta.clstr"
input_fasta = "Non_ABCP_clustered.fasta"
