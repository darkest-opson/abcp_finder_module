...
df = pd.read_csv("../ProtBERT_works/ProtBERT_embeddings_training.csv")
...
df_test = pd.read_csv("../ProtBERT_works/ProtBERT_embeddings_testing.csv")
...
plt.savefig(
    "ProtBERT_test_probability_distribution.tiff",
    dpi=600,
    format="tiff"
)
...
plt.savefig(
    "ProtBERT_test_metrics_colorful_barplot.tiff",
    dpi=600,
    format="tiff"
)
